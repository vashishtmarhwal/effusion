    ...
    public partial class Effusion : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            commands.Add(new string[] { "mail","open" ,"close", " history","V I T",
               "back", "previous", "find" , "new tab" , "next","face book", "refresh", "duck duck go","yaahoo","exit","google","google","youtube","moodle","one"});
        ...
        private void RecEngine_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            switch (result)
            {
                ...
                case "mail":
                    addTabToolStripMenuItem_Click(sender, e);
                    toolStripComboBox1.Text = "https://mail.google.com";
                    goToolStripMenuItem_Click(sender, e);
                    break;
            }
        }
        ...
        {
            addTabToolStripMenuItem_Click(sender, e);
            toolStripComboBox1.Text = "file:///C:/Users/Udai/source/repos/Effusion/Effusion/bin/Debug/history.xml";
            goToolStripMenuItem_Click(sender, e);
        }
    }
}
